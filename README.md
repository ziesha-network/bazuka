...
Example to initialize a node with 2 bootstrap nodes `23.34.12.45:8765` and `34.56.78.23:8765` on the `groth-2` network:

```
bazuka init --network groth-2 --bootstrap 23.34.12.45:8765 --bootstrap 34.56.78.23:8765
```
